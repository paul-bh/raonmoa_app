...
class DustsChartPage extends StatefulWidget {
  late List<double> initialData;

  DustsChartPage({Key? key, required this.initialData}) : super(key: key);

  @override
  State<DustsChartPage> createState() => _DustsChartPageState();
}

class _DustsChartPageState extends State<DustsChartPage> {
  ...
  double _touchedY = 0;
  bool _touched = false;
  Color mainColor = Color.fromRGBO(231, 206, 141, 1);
                ...
                AnimatedOpacity(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${_touchedY.toStringAsFixed(2)} μg/m³',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 24,
                ...
                AnimatedOpacity(
                  ...
                  child: Container(
                    ...
                    child:
                      ...
                      children: [
                        // make a tab selector that changes the selected mode. 0: 미세먼지, 1: 초미세먼지
                        Container(
                          height: 50,
                          child: Row(
                            ...
                            ? Container(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      '${_selectedMode == 0 ? widget.initialData[0].toStringAsFixed(2) : widget.initialData[1].toStringAsFixed(2)} μg/m³',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                snapshot.data?.forEach((key, value) {
                  if (_selectedMode == 0)
                    spots.add(FlSpot(double.parse(key.toString()), double.parse(value['pm'].toString())));
                  else
                    spots.add(FlSpot(double.parse(key.toString()), double.parse(value['upm'].toString())));
                });
                // sort spots
                ...
                mainColor = _selectedMode == 0 ? Color.fromRGBO(231, 206, 141, 1) : Color.fromRGBO(167, 141, 90, 1);
                    ...
                    Container(
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          minY: 0,
                          maxY: _highestY > 151 ? _highestY + 100 : 151,
                          borderData: FlBorderData(
                              show: true, border: Border.all(color: Colors.red, width: 1, style: BorderStyle.none)),
                          extraLinesData: ExtraLinesData(
                            extraLinesOnTop: true,
                            horizontalLines: _selectedMode == 0 ? ChartExtraLinesStandards.pm : ChartExtraLinesStandards.upm,
                            verticalLines: [
                              if (_touched == true)
                                VerticalLine(
                                  x: _touchedX,
                          ...
                          lineBarsData: <LineChartBarData>[
                            LineChartBarData(
                              ...
                              isCurved: Settings.useHighCapacityMode ? false : true,
                              curveSmoothness: 0.4,
                              ...
                              dotData: FlDotData(
                                getDotPainter: (p0, p1, p2, p3) {
                                  ...
                                  if (p0.y == _lowestY || p0.y == _highestY) {
                                    return FlDotCirclePainter(
                                      radius: 3,
                                      color: Colors.black,
                                      strokeWidth: 1,
                              ...
                              getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
                                ...
                                return touchedBarSpots.map((barSpot) {
                                  return LineTooltipItem(
                                    barSpot.y.toStringAsFixed(2) + 'μg/m³',
                                    TextStyle(
                                      color: Colors.black,
                                      fontSize: 15,
                                      fontWeight: FontWeight.bold,
                                    ...
                                    children: <TextSpan>[
                                      // show 'max' and 'min' text when the value is the highest or the lowest
                                      if (barSpot.y == _highestY)
                                        TextSpan(
                                          text: '\n(최고)',
                                          style: TextStyle(
                                            color: Colors.black,
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_highestY.toStringAsFixed(2)} μg/m³',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_lowestY.toStringAsFixed(2)} μg/m³',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_averageY.toStringAsFixed(2)} μg/m³',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
