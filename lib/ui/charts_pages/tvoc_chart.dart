...
class TVOCChartPage extends StatefulWidget {
  late double initialData;

  TVOCChartPage({Key? key, required this.initialData}) : super(key: key);

  @override
  State<TVOCChartPage> createState() => _TVOCChartPageState();
}

class _TVOCChartPageState extends State<TVOCChartPage> {
                ...
                AnimatedOpacity(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${_touchedY.toStringAsFixed(2)} ppb',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 24,
                            ...
                            ? Container(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      '${widget.initialData.toStringAsFixed(2)} ppb',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                snapshot.data?.forEach((key, value) {
                  spots.add(FlSpot(double.parse(key.toString()), double.parse(value['tvoc'].toString())));
                });
                // sort spots
                              ...
                              getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
                                ...
                                return touchedBarSpots.map((barSpot) {
                                  return LineTooltipItem(
                                    barSpot.y.toStringAsFixed(2) + 'ppb',
                                    TextStyle(
                                      color: Colors.black,
                                      fontSize: 15,
                                      fontWeight: FontWeight.bold,
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_highestY.toStringAsFixed(2)} ppb',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_lowestY.toStringAsFixed(2)} ppb',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_averageY.toStringAsFixed(2)} ppb',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
