...
class COandCO2ChartPage extends StatefulWidget {
  late List<double> initialData;

  COandCO2ChartPage({Key? key, required this.initialData}) : super(key: key);

  @override
  State<COandCO2ChartPage> createState() => _COandCO2ChartPageState();
}

class _COandCO2ChartPageState extends State<COandCO2ChartPage> {
                ...
                AnimatedOpacity(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${_touchedY.toStringAsFixed(2)} ppm',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 24,
                            ...
                            ? Container(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      '${_selectedMode == 0 ? widget.initialData[1].toStringAsFixed(2) : widget.initialData[0].toStringAsFixed(2)} ppm',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                snapshot.data?.forEach((key, value) {
                  if (_selectedMode == 0)
                    spots.add(FlSpot(double.parse(key.toString()), double.parse(value['co2'].toString())));
                  else
                    spots.add(FlSpot(double.parse(key.toString()), double.parse(value['co'].toString())));
                });
                // sort spots
                spots.sort((a, b) => a.x.compareTo(b.x));

                // but if Settings.useHighCapacityMode is false, remove spots that are too close to each other based on the given 'Settings.graphViewIntervalSeconds'.
                ...
                mainColor = _selectedMode == 0 ? Colors.purple : Colors.green;
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          extraLinesData: ExtraLinesData(
                            ...
                            horizontalLines: _selectedMode == 0 ? ChartExtraLinesStandards.co2 : ChartExtraLinesStandards.co,
                            verticalLines: [
                              if (_touched == true)
                                VerticalLine(
                                  x: _touchedX,
                          ...
                          gridData: FlGridData(
                            ...
                            horizontalInterval: _selectedMode == 0 ? 500 : 25,
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_highestY.toStringAsFixed(2)} ppm',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_lowestY.toStringAsFixed(2)} ppm',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${_averageY.toStringAsFixed(2)} ppm',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
