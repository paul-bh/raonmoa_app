...
class TemperatureChartPage extends StatefulWidget {
  ...
  TemperatureChartPage({Key? key, required this.initialData}) : super(key: key);
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                snapshot.data?.forEach((key, value) {
                  spots.add(FlSpot(double.parse(key.toString()), double.parse(value['temperature'].toString())));
                });
                // sort spots
                    ...
                    Container(
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          maxY: _highestY > 30 ? _highestY + 5 : 30,
