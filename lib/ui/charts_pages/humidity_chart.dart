...
class HumidityChartPage extends StatefulWidget {
  ...
  HumidityChartPage({Key? key, required this.initialData}) : super(key: key);

  @override
  State<HumidityChartPage> createState() => _HumidityChartPageState();
}
                            ...
                            ? Container(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      '${widget.initialData.toStringAsFixed(2)} °C',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                snapshot.data?.forEach((key, value) {
                  spots.add(FlSpot(double.parse(key.toString()), double.parse(value['humidity'].toString())));
                });
                // sort spots
                    ...
                    Container(
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          minY: _lowestY < 0 ? _lowestY - 5 : 0,
                          maxY: _highestY > 100 ? _highestY + 5 : 100,
