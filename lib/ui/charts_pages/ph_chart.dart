...
class PHChartPage extends StatefulWidget {
  ...
  PHChartPage({Key? key, required this.initialData}) : super(key: key);

  @override
  State<PHChartPage> createState() => _PHChartPageState();
}
                ...
                AnimatedOpacity(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'pH ${_touchedY.toStringAsFixed(2)}',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 24,
                  ...
                  child: Container(
                    ...
                    child:
                      ...
                      children: [
                        ...
                        // only show 현재 if the last spot is today and same as last spot
                            ...
                            ? Container(
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'pH ${widget.initialData.toStringAsFixed(2)}',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 24,
                                        fontWeight: FontWeight.bold,
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                snapshot.data?.forEach((key, value) {
                  spots.add(FlSpot(double.parse(key.toString()), double.parse(value['ph'].toString())));
                });
                // sort spots
                ...
                return Column(
                  children: [
                    ...
                    //* show today's highest and lowest pH.
                    Container(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'pH ${_highestY.toStringAsFixed(2)}',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            // show as: (H:MM, H:MM, H:MM because there are multiple values with the same pH)
                                            ' ${() {
                                              String result = '';
                                              int count = 0;
                                              for (int i = 0; i < spots.length; i++) {
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'pH ${_averageY.toStringAsFixed(2)}',
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold,
